      ...
      public function add_powr_js(){
        ...
        if($POWR_JS_ADDED){
          return;
		    ...
		    $js_url = JURI::base()."modules/mod_powrcountdowntimer/powr_joomla.js";
        $js = "(function(d){
...
//Create Helper
new PowrHelper();
echo "<div class='powr-countdown-timer' label='joomla_$module->id'></div>";
?>